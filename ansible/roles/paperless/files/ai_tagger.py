...
def main():
    ...
    prompt = (
        ...
        f"- Typ: ZWINGEND exakt EINEN Typ aus dieser Liste kopieren: {ERLAUBTE_TYPEN}. Erfinde keine eigenen Typen, auch nicht 'Verkauf' oder 'Bestellung'!\n"
        "  Zuordnung: Alles von einem Online-Shop mit Preisen (Rechnung, Bestellübersicht, Bestellbestätigung, Lieferschein) = 'Rechnung'. Kassenbon, Restaurant, Tankstelle = 'Quittung'. Amt, Behörde, Krankenkasse, Studierendenwerk = 'Bescheid'. Kontoauszug oder Umsatzanzeige einer Bank = 'Bankbeleg'.\n"
        "  Im Zweifel gilt: steht ein Kaufbetrag drauf, ist es 'Rechnung'.\n"
